...
<template>
  <div class="container-lg p-4">
    <div class="d-flex flex-row gap-2 fs-3 align-items-center">
      ...
      <a href="https://github.com/x65534/visuali" target="_blank" class="icon-link">
        <FontAwesomeIcon :icon="faGithub" class="text-secondary" />
      </a>
    </div>
    <p class="fs-4">
      Injection attack visualiser developed by
      <a href="https://x65534.io" target="_blank" class="text-secondary">rob</a>
    </p>
  </div>
</template>
